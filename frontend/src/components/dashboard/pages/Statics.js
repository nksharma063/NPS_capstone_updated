...
export default function Statics() {
  ...
  React.useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const resStat = await axios.get(`${calServiceUrl}/stat/allstat`);
                ...
                <Grid item xs={12}>
                  ...
                  >
                    <FormControl fullWidth>
                      ...
                      >
                        {[...new Set(dataStat.map((d) => d.npsFormName))].map(
                          (uniqueNpsFormName) => (
                            <MenuItem
                              key={uniqueNpsFormName}
                      ...
                      <InputLabel id="npsType">NPS Type</InputLabel>
                      <Select
                        labelId="npsType"
                        id="npsType"
                        value={forms}
                    ...
                    <NpsOrders title="Overall Stats" data={dataStat} />
                  </Paper>
                </Grid>
              </Grid>
              <Copyright sx={{ pt: 4 }} />
